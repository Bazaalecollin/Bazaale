...
$sql_connection->query("INSERT INTO users(NAME,DISTRICT_ID,PASSWORD,EMAIL_ADDRESS)VALUES('$pName','$district','$user_password','$emailAddress')");
...
$gateway->sendMessage("+256784913692", $message); 
